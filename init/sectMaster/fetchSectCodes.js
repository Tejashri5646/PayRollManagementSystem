...
async function fetchSectCodes() {
    try {
        ...
        const sql = 'SELECT code, name FROM sectCodes';
        ...
        if (rows.length === 0) {
            console.log('No data found in the sectCodes table');
            return [];
        }
